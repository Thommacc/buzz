...
pub fn run() {
    ...
    let app = app_menu::install(builder)
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            upsert_workforce_draft_community,
            set_workforce_community_membership,
            set_workforce_company_model_override,
            propose_workforce_context_fact,
            review_workforce_context_fact,
            preview_workforce_task_route,
